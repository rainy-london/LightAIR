...
def create_optimizer(args, model):
    ...
    optimizer_grouped_parameters = [
        {"params": [], "weight_decay": wd, "lr": lr, "ratio": ratio},
        {"params": [], "weight_decay": 0.0, "lr": lr, "ratio": ratio},
        {"params": [], "weight_decay": wd, "lr": lr * lr_mult, "ratio": ratio},
        {"params": [], "weight_decay": 0.0, "lr": lr * lr_mult, "ratio": ratio},
    ]
